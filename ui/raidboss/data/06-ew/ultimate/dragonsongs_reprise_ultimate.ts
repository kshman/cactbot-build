    ...
    },
    {
      ...
      run: (data) => {
        if ((data.prsRavanaCount ?? 0) === 2) {
          delete data.prsRavana1;
          delete data.prsRavana2;
          delete data.prsRavanaCount;
        }
      },
      outputStrings: {
        sword1: {
