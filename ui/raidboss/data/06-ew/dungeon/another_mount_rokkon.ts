  ...
  triggers: [
    ...
    },
    {
      ...
      response: (data, _matches, output) => {
        ...
        output.responseOutputStrings = {
          backOnYou: {
            en: 'Back Tether (w/${partners})',
            de: 'Zurück-Verbindung (w/${partners})',
            ja: '後ろの線 (${partners})',
            ko: '뒤로 줄: ${partners}',
          },
          // These are probably impossible.
          leftOnYou: {
            en: 'Left Tether (w/${partners})',
            de: 'Links-Verbindung (w/${partners})',
            ja: '左の線 (${partners})',
            ko: '왼쪽 줄: ${partners}',
          },
          frontOnYou: {
            en: 'Front Tether (w/${partners})',
            de: 'Vorne-Verbindung (w/${partners})',
            ja: '前の線 (${partners})',
            ko: '앞쪽 줄: ${partners}',
          },
          rightOnYou: {
            en: 'Right Tether (w/${partners})',
            de: 'Rechts-Verbindung (w/${partners})',
            ja: '右の線 (${partners})',
            ko: '오른쪽 줄: ${partners}',
          },
          unmarked: {
