...
const triggerSet: TriggerSet<Data> = {
  ...
  triggers: [
    // 게룡: Colossal Strike
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '74CF', source: 'Geryon the Steer', capture: false },
    ...
    // 게룡: Colossal Slam
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '74D0', source: 'Geryon the Steer', capture: false },
    ...
    // 게룡: Gigantomill
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: ['74C9', '74CA'], source: 'Geryon the Steer', capture: false },
      infoText: '장판(➕) 피해요',
    },
    ...
    // 실키: Carpet Beater
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '772B', source: 'Silkie', capture: false },
      response: Responses.tankBuster(),
    },
    // 실키: Chilling Suds
    {
    ...
    // 실키: Chilling Duster (773B은 Soap's Up, 773F는 Soaping Spree)
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '773[BF]', source: 'Silkie', capture: false },
      infoText: '십자➕ 장판',
    },
    // 실키: Bracing Suds
    {
    ...
    // 글라디에이터: Mighty Smite
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '7657', source: 'Gladiator of Sil\'dih', capture: false },
      response: Responses.tankBuster(),
    },
    // 글라디에이터: Ring of Might 1
    {
      ...
      type: 'Ability',
      netRegex: { id: '7642', source: 'Gladiator of Sil\'dih', capture: false },
      durationSeconds: 8,
      infoText: '링 차지 ❶',
    },
    // 글라디에이터: Ring of Might 2
    {
      ...
      type: 'Ability',
      netRegex: { id: '7643', source: 'Gladiator of Sil\'dih', capture: false },
      durationSeconds: 8,
      infoText: '링 차지 ❷',
    },
    // 글라디에이터: Ring of Might 3
    {
      ...
      type: 'Ability',
      netRegex: { id: '7644', source: 'Gladiator of Sil\'dih', capture: false },
      durationSeconds: 8,
      infoText: '링 차지 ❸',
    },
    ...
    // 젤레스 가:Firesteel Fracture
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '74AC', source: 'Shadowcaster Zeless Gah', capture: false },
      response: Responses.tankBuster(),
    },
    // 젤레스 가:Infern Brand
    {
    ...
    // 젤레스 가:Cryptic Portal
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '7492', source: 'Shadowcaster Zeless Gah', capture: false },
      infoText: '크립틱 포탈',
    },
    ...
    // 쏜: Blistering Blow
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '70EA', source: 'Thorne Knight', capture: false },
      response: Responses.tankBuster(),
    },
    // 쏜: Fore Honor
    {
    ...
    // 쏜: Slashburn
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '70EF', source: 'Thorne Knight', capture: false },
      infoText: '🔵🔴🔵: 파랑 사이',
    },
    // 쏜: 리버스 Slashburn
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: ['70F0', '70F1'], source: 'Thorne Knight', capture: false },
      infoText: '🔵🔵🔴: [반대쪽]으로',
    },
    // 쏜: Slashburn + Glory
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '7102', source: 'Thorne Knight', capture: false },
