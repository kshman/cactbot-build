  ...
  timelineReplace: [
    {
      'locale': 'de',
      'replaceSync': {
        'Heavenly Hyoga': 'Himmelssaulen-Hyoga',
        'Heavenly Ichijama': 'Himmelssaulen-Ichijama',
        'Heavenly Mammoth': 'Himmelssaulen-Mammut',
        'Heavenly Tofu': 'Himmelssaulen-Tofu',
    ...
    },
    {
      'locale': 'ja',
      'replaceSync': {
        'Heavenly Hyoga': '«¢«á«Î?«Ò«ç«¦«¬',
        'Heavenly Ichijama': '«¢«á«Î?«¤«Á«¸«ã«Þ',
        'Heavenly Mammoth': '«¢«á«Î?«Þ«ó«â«¹',
        'Heavenly Tofu': '«¢«á«Î?«È«¦«Õ',
        'Kajigakaka': '«««¸«¬««««',
      },
    },
    {
      'locale': 'cn',
      'replaceSync': {
        'Heavenly Hyoga': 'ô¸ñý?ä³',
        'Heavenly Ichijama': 'ô¸ñýßæÞ÷Øª',
        'Heavenly Mammoth': 'ô¸ñý?Ù¾ßÚ',
        'Heavenly Tofu': 'ô¸ñýÔçÝ¯',
        'Kajigakaka': '?å§?',
      },
    },
    {
      'locale': 'ko',
      'replaceSync': {
        'Heavenly Hyoga': 'Ãµ±Ã È¿¿ì°¡',
        'Heavenly Ichijama': 'Ãµ±Ã »ý·É',
        'Heavenly Mammoth': 'Ãµ±Ã ¸Å¸Óµå',
        'Heavenly Tofu': 'Ãµ±Ã µÎºÎ',
        'Kajigakaka': 'Ä«Áö°¡Ä«Ä«',
      },
    },
  ],
