  ...
  timelineReplace: [
    {
      'locale': 'de',
      'replaceSync': {
        'Heavenly Gozu': 'Himmelssaulen-Gozu',
        'Heavenly Jaki': 'Himmelssaulen-Jaki',
        'Heavenly Jinba': 'Himmelssaulen-Jinba',
        'Heavenly Kyozo': 'Himmelssaulen-Kyozo',
        'Heavenly Mifune': 'Himmelssaulen-Mifune',
        'Heavenly Tenma': 'Himmelssaulen-Tenma',
      },
    },
    {
      'locale': 'fr',
      'replaceSync': {
        ...
        'Heavenly Kyozo': 'kyozo des Cieux',
    ...
    },
    {
      ...
      'replaceSync': {
        'Heavenly Gozu': '«¢«á«Î?«´«º',
        'Heavenly Jaki': '«¢«á«Î?«¸«ã«­',
        'Heavenly Jinba': '«¢«á«Î?«¸«ó«Ð',
        'Heavenly Kyozo': '«¢«á«Î?«­«ç«¦«¾«¦',
        'Heavenly Mifune': '«¢«á«Î?«ß«Õ«Í',
        'Heavenly Tenma': '«¢«á«Î?«Æ«ó«Þ',
      },
    },
    {
      'locale': 'cn',
      'replaceSync': {
        'Heavenly Gozu': 'ô¸ñýéÚ?',
        'Heavenly Jaki': 'ô¸ñýÞ÷Ð¡',
        'Heavenly Jinba': 'ô¸ñýìÑ?',
        'Heavenly Kyozo': 'ô¸ñý?ßÀ',
        'Heavenly Mifune': 'ô¸ñýß²àÏ',
        'Heavenly Tenma': 'ô¸ñý?',
      },
    },
    {
      'locale': 'ko',
      'replaceSync': {
        'Heavenly Gozu': 'Ãµ±Ã ¼Ò¸Ó¸®',
        'Heavenly Jaki': 'Ãµ±Ã »ç±Í',
        'Heavenly Jinba': 'Ãµ±Ã ÀÎ¸¶',
        'Heavenly Kyozo': 'Ãµ±Ã °Å¿ï±â»ç',
        'Heavenly Mifune': 'Ãµ±Ã ¹ÌÈÄ³×',
        'Heavenly Tenma': 'Ãµ±Ã Ãµ¸¶',
      },
    },
  ],
};
